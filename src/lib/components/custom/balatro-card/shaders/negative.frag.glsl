// Balatro negative.fs — exact port to WebGL2
// HSL inversion with brownish-gray offset, NOT simple RGB inversion
...
void main()
{
    ...
    // negative vec2 from Balatro: [send_to_shader[1], send_to_shader[2]]
    vec2 negative = edition_params;
